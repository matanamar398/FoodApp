...
export default function MealsPics({handleAddProduct}) {
  const [expanded, setExpanded] = React.useState(false);
  const {productItems} = MealsData;
  ...
  return (
    ...
    <Card sx={{ maxWidth: 345 }}>
      ...
      <CardActions disableSpacing>
        ...
        <button onClick={() => handleAddProduct(productItem)} style={{ color:'#000000',fontSize:25,border:'none',backgroundColor:'#fff',opacity:0.7, cursor:"pointer"}}><Plus onClick={handleClick}/></button>
      </CardActions>
    </Card>
    </Grid>
